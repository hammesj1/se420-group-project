...
PacketSwitch::PacketSwitch(std::string new_vendor, std::string new_model, double new_power, int new_mtu, float height, float width, float depth)
{
        vendor          = new_vendor;
        model           = new_model;
        power           = new_power;
